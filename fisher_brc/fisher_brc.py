...
class FisherBRC:
    ...
    def behavior_weights(self):
        return {
            "bc_alpha": self.bc_log_alpha,
            "behavior": self.behavior.state_dict(),
        }
    
    def save_behavior(self, batch_num):
        torch.save(self.behavior_weights(), self.cfg.model_save_path + self.exp_dir + f"/behavior_{batch_num}.pth")
